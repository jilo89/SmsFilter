...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
     ...
     */
    private int memoryCapacity = 160000;
     ...
     * probability.
     *
     * @see com.lusa.jilowa.smsfilterapp.Classifier#featureProbability(Object, Object)
     * @see com.lusa.jilowa.smsfilterapp.Classifier#featureWeighedAverage(Object, Object, IFeatureProbability, float, float)
     *
