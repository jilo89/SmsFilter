...
/**
 * Created by JILOWA on 26-Mar-16.
 */
public class SpamContact extends AsyncTask<String,Void, List<String>> {
    private static final String INBOX_URI = "content://sms/inbox";
    private List<String> smsList= new ArrayList<>();
    private Context context;
   // private ProgressDialog progressDialog;
    private OnSpamLoaded onSpamLoaded;

    public SpamContact(Context context, OnSpamLoaded onSpamLoaded) {
        this.context=context;
        this.onSpamLoaded=onSpamLoaded;
...
//        }
    ...
    @Override
    protected void onPostExecute(List<String> smsList) {
        onSpamLoaded.onSpamLoadedSuccess(smsList);
